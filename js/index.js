 ...
 // let products = [
  ...
  function renderProduct() {
    ...
    for(let i = 0 ; i< products.length; i++){
      ...
      <a onclick="productDetail(${products[i].id})" href="./pages/detailProduct.html"><div class="swiper-slide box">
  ...
  function productDetail(idProductDetail){
     localStorage.setItem("checkIdDetailProduct",JSON.stringify(idProductDetail));
  }
